      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '40px', marginBottom: '48px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.82rem', color: 'var(--color-cyan)', fontWeight: 600 }}>
          ...
          {/* Col 2: Services */}
          <div>
            <h4 style={{ color: '#FFF', fontSize: '0.95rem', fontWeight: 700, marginBottom: '16px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px' }}>
            ...
            <a href="#leadership" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Leadership</a>
            <a href="#keepalive" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>Supabase Engine</a>
